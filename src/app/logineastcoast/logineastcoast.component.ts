...
@Component({
  selector: 'app-logineastcoast',
  templateUrl: './logineastcoast.component.html',
  styleUrls: ['./logineastcoast.component.scss']
})
export class LogineastcoastComponent implements OnInit {
  ...
  constructor(public router: Router, public dialog: MatDialog, public snackBar: MatSnackBar,
    public _appService: AppService, public formBuilder: FormBuilder, public dialogRef: MatDialogRef<LogineastcoastComponent>,
