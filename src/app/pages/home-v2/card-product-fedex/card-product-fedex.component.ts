...
import { Etiquetas, ambiente } from 'src/app/app.modelsWebShop';
...
@Component({
  selector: 'app-card-product-fedex',
  templateUrl: './card-product-fedex.component.html',
  styleUrls: ['./card-product-fedex.component.scss']
})
export class CardProductFedexComponent implements OnInit {
  ...
  @Output() refrescarTarjetas: EventEmitter<void> = new EventEmitter();
