...
@Component({
  selector: 'app-card-product-tropical',
  templateUrl: './card-product-tropical.component.html',
  styleUrls: ['./card-product-tropical.component.scss']
})
export class CardProductTropicalComponent implements OnInit {
