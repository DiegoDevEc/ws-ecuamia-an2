...
@Component({
  selector: 'app-loginpinnacle',
  templateUrl: './loginpinnacle.component.html',
  styleUrls: ['./loginpinnacle.component.scss']
})
export class LoginpinnacleComponent implements OnInit {
  ...
  constructor(public router: Router, public dialog: MatDialog, public snackBar: MatSnackBar,
    public _appService: AppService, public formBuilder: FormBuilder, public dialogRef: MatDialogRef<LoginpinnacleComponent>,
