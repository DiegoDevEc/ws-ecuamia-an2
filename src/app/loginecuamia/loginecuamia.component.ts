...
@Component({
  selector: 'app-loginecuamia',
  templateUrl: './loginecuamia.component.html',
  styleUrls: ['./loginecuamia.component.scss']
})
export class LoginEcuamiaComponent implements OnInit {
  ...
  constructor(public router: Router, public dialog: MatDialog, public snackBar: MatSnackBar, private route: ActivatedRoute,
    public _appService: AppService, public formBuilder: FormBuilder, public dialogRef: MatDialogRef<LoginEcuamiaComponent>,
    @Inject(MAT_DIALOG_DATA) public data: any, public appService: AppService, private encryptionService: EncryptionService,
    public appWebshopService: AppWebshopService, private websocketService: WebsocketService, private deviceSessionService: DeviceSessionService) {
